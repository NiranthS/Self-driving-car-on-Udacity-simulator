...
def load_image(data_dir, image_file):
    ...
    """
    # print(data_dir)
    # print("loadingggggggggggggggggggggggggggggggg")
...
def choose_image(data_dir, image_name, steering_angle):
    """
...
def random_flip(image, steering_angle):
    ...
    """
    # print("flippinggggggggggggggggggggggggggggggggggg")
...
def random_translate(image, steering_angle, range_x, range_y):
    ...
    """
    # print("translatinggggggggggggggggggggggggggggggggggggg")
...
def random_shadow(image):
    ...
    # print("shadowinggggggggggggggggggggggggggggggggg")
...
def random_brightness(image):
    ...
    # print("brighteningggggggggggggggggggggggggggggg")
...
def augument(data_dir, image_name, steering_angle, range_x=100, range_y=10):
    """
    ...
    #     steering_angle = steering_angle 
    image, steering_angle = choose_image(data_dir, image_name, steering_angle)
...
def batch_generator2(data_dir, image_paths, steering_angles, batch_size, is_training):
    ...
    while True:
        i = 0
        # print('1111111111111111111111111111111111111111111111111',len(image_paths))
        for index in np.random.permutation(len(image_paths)):
            image_name = image_paths[index]
            # print ("this is name",image_name,"2222222222222222222222222222222222222222222222222222")
            steering_angle = steering_angles[index]
            # print("type",type(steering_angle))
            # steering_angle=float(steering_angle)
            # argumentation
            if is_training and np.random.rand() < 0.6:
                # print("here44444444444444444444444444444444444444444444444444444444444444")
                image, steering_angle = augument(data_dir, image_name, steering_angle)
            else:
                # print("here55555555555555555555555555555555555555555555555555555555555555")
                image = load_image(data_dir, image_name) 
